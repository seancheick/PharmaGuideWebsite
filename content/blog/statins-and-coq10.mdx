...
description: "Statins lower cholesterol — and they also lower CoQ10. Whether you should supplement is a more nuanced question than the wellness internet makes it out to be. Here's what the controlled trials, the meta-analyses, and the cardiology guidelines actually say."
...
<Callout tone="accent">
**Reading on PharmaGuide.io?** Join the beta to see medication-depletion checks across your full stack — every prescription you add gets cross-referenced against the depletion patterns in the published literature, reviewed by our clinical pharmacist.
